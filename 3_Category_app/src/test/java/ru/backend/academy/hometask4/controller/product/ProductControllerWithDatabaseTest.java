...
@Testcontainers
@ContextConfiguration(initializers = ProductControllerWithDatabaseTest.DataSourceInitializer.class)
@DisplayNameGeneration(DisplayNameGenerator.ReplaceUnderscores.class)
public class ProductControllerWithDatabaseTest implements ProductControllerTest {
    ...
    void setUp() {
        ...
        categoryJpaRepository.save(testCategory);
    ...
    public void get_all_products_by_category_should_return_product_list() throws Exception {
        Product product1 = new Product("ITEM1", "Product 1", 10.0f, 5, categoryJpaRepository.defaultCategory);
        Product product2 = new Product("ITEM2", "Product 2", 20.0f, 10, testCategory);
        List<Product> productList = List.of(product1, product2);
        productJpaRepository.saveAll(productList);
