...
import ru.backend.academy.hometask4.service.impl.jpa.CategoryJpaServiceImpl;
...
@SpringBootTest
@Testcontainers
@ContextConfiguration(initializers = CategoryJpaServiceImplTest.DataSourceInitializer.class)
public class CategoryJpaServiceImplTest {
