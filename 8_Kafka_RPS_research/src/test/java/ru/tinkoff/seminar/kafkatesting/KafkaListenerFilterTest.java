...
import ru.tinkoff.seminar.kafkatesting.kafka.listener.KafkaManualFilterListener;
...
@SpringBootTest(classes = {
        ...
        KafkaConsumer.class,
        KafkaManualFilterListener.class,
        BaseConfig.class
}, properties = {
        "topic=topic",
...
@DisplayName("Пакетное чтение с фильтром в листенере с гарантией чтения")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@EmbeddedKafka(partitions = 1, topics = {"topic"})
public class KafkaListenerFilterTest {
    ...
    @Autowired
    KafkaManualFilterListener kafkaConsumerListener;
