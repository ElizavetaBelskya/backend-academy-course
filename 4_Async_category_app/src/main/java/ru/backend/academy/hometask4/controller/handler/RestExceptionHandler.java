package ru.backend.academy.hometask4.controller.handler;
...
import ru.backend.academy.hometask4.dto.errors.ExceptionDto;
import ru.backend.academy.hometask4.dto.errors.ValidationErrorDto;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ExceptionDto> handleProductDatabaseException(BaseDatabaseException ex) {
