...
@Testcontainers
@ContextConfiguration(initializers = CategoryControllerTestIpml.DataSourceInitializer.class)
@DisplayNameGeneration(DisplayNameGenerator.ReplaceUnderscores.class)
public class CategoryControllerTestIpml implements CategoryControllerTest {
